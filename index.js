...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `ᴏᴘᴀ ᴇᴀᴇ  @${num.split('@')[0]}\nsᴇᴊᴀ ʙᴇᴍ ᴠɪɴᴅᴏ ᴀᴏ ɢʀᴜᴘᴏ *${mdata.subject}* ʟᴇɪᴀ ᴀs ʀᴇɢʀᴀs ᴘᴀʀᴀ ɴᴀᴏ sᴇʀ ʙᴀɴɪᴅᴏ\n ᴇ ɴᴀᴏ sᴇᴊᴀ ᴜᴍ ɢʜᴏsᴛ シ︎`
				...
				teks = `ᴊᴀ ғᴏɪ ᴛᴀʀᴅᴇ😂 @${num.split('@')[0]} ᴇsᴘᴇʀᴏ ǫᴜᴇ ᴛᴇɴʜᴀ ɪᴅᴏ ᴘᴀʀᴀ ɴᴀᴏ ᴠᴏʟᴛᴀʀ シ︎`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛Esᴛᴏᴜ ғᴀᴢᴇɴᴅᴏ ᴀǫᴜɪ sᴇᴜ ᴍɪᴛᴏ ( ᴀ ) シ︎☺️',
				success: '😎️Mᴇᴜ Cᴀʀᴏ Dᴇᴜ Bᴀᴜᴍ😎',
                                levelon: '⚠️Hᴀʙɪʟɪᴛᴀʀ Lᴇᴠᴇʟ シ︎⚠️',
				leveloff: '⚠Dᴇsᴀʙɪʟɪᴛᴀʀ Lᴇᴠᴇʟ シ︎⚠️',
				levelnoton: '⚠️Lᴇᴠᴇʟ Aᴛɪᴠᴏ シ︎⚠️',
				levelnol: '*Pqp animal level* 0 ',
				error: {
					stick: '⚠️Eʀʀᴏ ᴀᴏ ᴄᴏɴᴠᴇʀᴛᴇʀ ɪᴍᴀɢᴇᴍ /ɢɪғ /ᴠɪᴅᴇᴏ ᴇᴍ ᴀᴅᴇsɪᴠᴏ シ︎⚠️',
					Iv: '⚠️Lɪɴᴋ ɪɴᴠᴀʟɪᴅᴏ シ︎⚠️'
				},
				only: {
					group: '[❗] Esᴛᴇ ᴄᴏᴍᴀɴᴅᴏ sᴏ ᴘᴏᴅᴇ sᴇʀ ᴜsᴀᴅᴏ ᴇᴍ ɢʀᴜᴘᴏs シ︎❗',
					ownerG: '[❗] Esᴛᴇ ᴄᴏᴍᴀɴᴅᴏ sᴏ ᴘᴏᴅᴇ sᴇʀ ᴜsᴀᴅᴏ ᴘᴇʟᴏ ᴅᴏɴᴏ ᴅᴏ ɢʀᴜᴘᴏ シ︎❗',
					ownerB: '[❗] Esᴛᴇ ᴄᴏᴍᴀɴᴅᴏ sᴏ ᴘᴏᴅᴇ sᴇʀ ᴜsᴀᴅᴏ ᴘᴇʟᴏ K1R1T0 シ︎❗',
					admin: '[❗] Esᴛᴇ ᴄᴏᴍᴀɴᴅᴏ sᴏ ᴘᴏᴅᴇ sᴇʀ ᴜsᴀᴅᴏ ᴘᴏʀ ᴜᴍ ᴀᴅᴍ ᴅᴏ ɢʀᴜᴘᴏ シ︎❗',
					Badmin: '[❗] Nᴇᴄᴇssᴀʀɪᴏ ʙᴏᴛ ᴛᴇʀ ᴀᴅᴍ ᴘᴀʀᴀ ғᴜɴᴄɪᴏɴᴀʀ シ︎❗ ',
...
*Tem que usar esse simbolo '|' pra separar nome de idade*.`,
			...
			const ownerNumber = ["554499862424@s.whatsapp.net"] // replace this with your number
              ...
              await client.sendMessage(from, options, text)
               break
					...
					try {
						...
						reply('⚠️ɴᴏᴍᴇ ᴅᴇ ᴜsᴜᴀʀɪᴏ ɪɴᴠᴀʟɪᴅᴏ シ︎⚠️ ')
					}
					break
				case 'snowwrite':
		...
		case 'spamcall':
               client.updatePresence(from, Presence.composing)
                ...
                break
                   ...
                   break
				case 'wiki':
					if (args.length < 1) return reply('ᴅɪɢɪᴛᴇ ᴀ ᴘᴀʟᴀᴠʀᴀ ᴄʜᴀᴠᴇ シ︎')
					tels = body.slice(6)	
                                        if (!isUser) return reply(mess.only.daftarB)				
				...
				case 'wikien':
					...
					break				
				case 'ytmp3':
					if (args.length < 1) return reply('ᴄᴀᴅᴇ ᴏ ʟɪɴᴋ ᴛɪᴏ シ︎?')
			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'info':
					...
					break
				case 'blocklist':
					teks = 'ɴᴜᴍᴇʀᴏs ᴅᴇ ǫᴜᴇᴍ ғᴀᴢ ᴍᴇʀᴅᴀ シ︎:\n'
				...
				case 'tts':
				   ...
				   if (args.length < 1) return client.sendMessage(from, 'ǫᴜᴀʟ ᴇ ᴀ sɪɢʟᴀ ᴅᴇ ʟɪɴɢᴜᴀɢᴇᴍ ?', text, {quoted: mek})
                                   if (!isUser) return reply(mess.only.daftarB)
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return client.sendMessage(from, 'ᴄᴀᴅᴇ ᴀ ғᴀʟᴀ ?', text, {quoted: mek})
					dtt = body.slice(8)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 600
				...
				case 'setprefix':
					...
					prefix = args[0]
					reply(`ᴏ ᴘʀᴇғɪxᴏ ғᴏɪ ᴀʟᴛᴇʀᴀᴅᴏ ᴘᴀʀᴀ シ︎  : ${prefix}`)
					break
				case 'meme':
                ...
                break
                   ...
                   break
					...
					break
                                  case 'daftar':
					client.updatePresence(from, Presence.composing)
					if (isUser) return reply('Vᴏᴄᴇ ᴊᴀ ᴇsᴛᴀ ʀᴇɢɪsᴛʀᴀᴅᴏ ᴍᴀɴɪɴᴀ 🥰')
					...
					if (args.length < 1) return reply('⚠️️ᴘᴀʀᴀ ᴀᴛɪᴠᴀʀ ᴅɪɢɪᴛᴇ  1⚠️')
					if (Number(args[0]) === 1) {
						if (isWelkom) return reply('⚠️ᴏ ʀᴇᴄᴜʀsᴏ ᴅᴇ ʙᴏᴀs ᴠɪɴᴅᴀs ᴊᴀ ᴇsᴛᴀ ᴀᴛɪᴠᴏ ️⚠️')
						welkom.push(from)
